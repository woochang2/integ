        ...
        try:
            ...
            for skewness in self.skewness:
                    ...
                    if self.duration >= 0:
                        ...
                        return LogParser.process(PathMaker.logs_path(), self.execution_model, faults=self.faults).result()
                    else:
                        return 'Running benchmark forever. You must explicitly kill the local benchmark by calling "tmux kill-server"...'  
